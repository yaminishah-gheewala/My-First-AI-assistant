    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-sky-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm">Start understanding your lab results in minutes</p>
        </div>
        <form
          onSubmit={onSubmit}
        ...
        <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-5">
          ...
          <Link href="/login" className="text-emerald-700 dark:text-emerald-400 font-medium hover:underline">
            Log in
          </Link>
        </p>
      </div>
