...
export default function NutrientSlider({
  ...
  return (
    <div>
      <div className="relative h-2.5 w-full rounded-full overflow-hidden bg-slate-100 flex">
        ...
        <div
          className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 h-4 w-4 rounded-full border-2 border-white shadow"
